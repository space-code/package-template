...
You can contribute by fixing bugs or adding new features. For larger code changes, we recommend first discussing your ideas on our [GitHub Discussions](https://github.com/space-code/{{ cookiecutter.name | lower }}/discussions). When submitting a pull request, please add relevant tests and ensure your changes don't break any existing tests.
...
See [CODE_OF_CONDUCT.md](https://github.com/space-code/{{ cookiecutter.name | lower }}/blob/master/CODE_OF_CONDUCT.md) for details.
